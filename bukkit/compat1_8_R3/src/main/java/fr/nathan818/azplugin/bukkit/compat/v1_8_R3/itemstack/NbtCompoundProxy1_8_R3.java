...
public class NbtCompoundProxy1_8_R3 implements NbtCompoundProxy {
    ...
    public NbtCompoundProxy1_8_R3(@NonNull Map<String, NBTBase> map, boolean unmodifiable) {
        this.map = map;
        this.unmodifiable = unmodifiable;
    }

    public NbtCompoundProxy1_8_R3(@NonNull NBTTagCompound compound, boolean unmodifiable) {
        this(CompatBridge1_8_R3.getNbtCompoundMap(compound), unmodifiable);
    }
